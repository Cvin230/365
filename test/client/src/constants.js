export const constants = {
  ...
  footer: {
    ...
    copyright: "© 2020 Ship365. All rights reserved Ship365 team",
  },
  faq: {
    faq1: {
      headline: "USPS tracking",
      subscribe:
        "USPS tracking is an optional feature for those who rely on the US Mail Service to send and receive packages. With the USPS tracking system, you can track the status of your shipments from the moment they are shipped until they are delivered. Every package shipped through the US Mail Service is assigned a unique USPS tracking number, also known as the US Mail Service Tracking Number, which is used to identify and track the package. USPS package tracking is available for most domestic and international shipping options, making it easier for you to stay informed about the status of your shipments regardless of where they are shipping to or from.Through the USPS tracking system, you can access information about the status of your packages such as the location, estimated delivery time, and delivery status.",
    },
    faq2: {
      headline: "US Postal Service and Mail Tracking",
      subscribe: `Tracking your USPS package is a simple process that can be done on the USPS website or through a third-party tracking site like Ship365. To track your package or mail item, you need your USPS tracking number, which can be found on your shipping label or package receipt.
        ...
        While USPS tracking can only track USPS packages, the universal Ship365 tracking system makes package tracking a non-issue. Ship365 constantly connects and scans hundreds of couriers and even more online shops, making sure you keep the most up-to-date with any developments on your USPS package. it can perform global tracking effectively regardless of the courier.`,
    },
    faq3: {
      headline: "Tracking USPS International Packages",
      subscribe: `USPS international package tracking can be done with a universal tracking solution. Ship365 does just that. You can enter your USPS international tracking number on the homepage and after a few seconds, Ship365 will give you all the tracking information needed for your package, whether it is domestic or international shipping. The great thing about tracking your USPS international package on Ship365 is that you can track up to 10 packages simultaneously.
...
Similarly, you can also get tracking USPS international tracking from their tracking website as well. While you can track up to 35 tracking numbers on the USPS website, separating each tracking number by putting may be a hassle and time-consuming.`,
    ...
    faq9: {
      ...
      subscribe: `The USPS Global Express Guaranteed tracking number consists of 10 digits and it is considered to be the fastest way to send packages internationally. You can get your USPS tracking from this service directly on their website or on the homepage of Ship365.`,
    },
    faq10: {
